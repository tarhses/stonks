...
const { nextTurn, cancelOffer } = require('./transitions')
const { MAKE_OFFER, OFFER_STATE, RESTART_OFFER, SELL_ANIMAL } = require('../../common/signals')

module.exports = class Offer extends State {
  playerId
  targetId
  animalId
  count

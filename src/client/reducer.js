...
import {
  ADD_PLAYER, AUCTION_END_STATE, AUCTION_STATE, CANCEL_OFFER, EARN_CAPITAL, END_AUCTION, END_GAME, END_STATE, JOIN_ROOM,
  MAKE_BID, MAKE_OFFER, OFFER_STATE, PAY_CAPITAL, REMOVE_PLAYER, RESTART_AUCTION, RESTART_OFFER, SELL_ANIMAL, SET_TIMER,
  START_AUCTION, START_OFFER, START_TURN, STOP_BID, TURN_STATE

...
import { CREATE_ROOM, FULL_ERROR, JOIN_ROOM, NAME_ERROR, NONEXISTENT_ERROR } from '../../common/signals.json'
  ...
  return (
    <div>
      ...
      <div style={{ float: 'right' }}>
        <p><small><code>Version 1.2.1 - (c) 2020, Pierre Luycx</code></small></p>
      </div>
    </div>
  )
}

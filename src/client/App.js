...
import {
  ADD_PLAYER, CANCEL_OFFER, EARN_CAPITAL, END_AUCTION, END_GAME, JOIN_ROOM, MAKE_BID, MAKE_OFFER, NONEXISTENT_ERROR,
  PAY_CAPITAL, RECREATE_ROOM, REMOVE_PLAYER, RESTART_AUCTION, RESTART_OFFER, SELL_ANIMAL, SEND_MESSAGE, SET_TIMER,
  START_AUCTION, START_OFFER, START_TURN
} from '../common/signals.json'
import {
  addPlayer, cancelOffer, earnCapital, endAuction, endGame, joinRoom, makeBid, makeOffer, payCapital, recreateRoom,
  removePlayer, restartAuction, restartOffer, sellAnimal, setTimer, startAuction, startOffer, startTurn
} from './actions.js'
